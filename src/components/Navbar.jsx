...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-gray-500 text-black p-4 flex justify-between items-center shadow-md px-[20px] z-50 md:px-16">
      {/* Logo (Always Visible) */}
      ...
      <div className="hidden md:flex">
        <Link
          className="mx-4 hover:text-white text-lg"
          to="/"
          onClick={closeMenu}
        >
          Home
