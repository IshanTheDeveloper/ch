  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-4xl xl:text-6xl font-bold text-white"
      >
        Connect Communities
      </motion.h2>
      ...
      >
        A platform designed to bring people together, share experiences, and
        grow as a community. We empower individuals to explore events, connect
        with like-minded people, and strengthen their faith through technology.
      </motion.p>
      ...
      <div className="flex flex-col p-0 md:flex-row items-center justify-between md:p-10 mx-4 md:mx-20">
        ...
        >
          <h2 className="text-3xl xl:text-5xl md:items-start font-bold flex flex-col sm:items-center mt-18 text-white">
            Unite, Innovate, <br />
            <span className="flex items-center gap-2">Connect, Inspire</span>
            Together
          </h2>
